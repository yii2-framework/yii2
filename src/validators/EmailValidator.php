...
class EmailValidator extends Validator
{
    ...
    /**
     * @var string The regular expression used to validate the part before the @ symbol, used if ASCII conversion fails
    ...
    /**
     * @var string The regular expression used to validate email addresses with the name part before the @ symbol, used
     * if ASCII conversion fails to validate the address.
     *
     * This property is used only when [[allowName]] is true.
     * @see allowName
     * @since 2.0.42
    ...
    /**
     * @var bool Whether to allow name in the email address (e.g. "John Smith <john.smith@example.com>"). Defaults to
     * false.
     *
     * @see fullPattern
     */
     ...
     *
     * Be aware that this check can fail due to temporary DNS problems even if the email address is valid and an email
     * would be deliverable. Defaults to false.
     */
    public $checkDNS = false;
    /**
     * @var bool Whether the validation process should take into account IDN (internationalized domain names). Defaults
     * to false meaning that validation of emails containing IDN will always fail.
     *
    ...
    /**
     * @var bool Whether [[enableIDN]] should apply to the local part of the email (left side of the `@`). Only applies
     * if [[enableIDN]] is `true`.
     *
     * @since 2.0.43
     */
     ...
     * @param string $value
     *
     * @return string|bool returns string if it is valid and/or can be converted, bool false if it can't be converted
     * and/or is invalid
     *
