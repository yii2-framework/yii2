...
class QueryBuilderUnionTest extends BaseQueryBuilderUnion
{
    ...
    public function testBuildUnion(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite UNION with multiple queries generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
    ...
    public function testBuildUnionSubqueryInFrom(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite UNION subquery in FROM clause generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
    ...
    public function testBuildUnionAllSubqueryInFrom(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite UNION ALL subquery in FROM clause generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
    ...
    public function testBuildUnionSubqueryInJoin(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite UNION subquery in JOIN clause generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
    ...
    public function testBuildUnionSubqueryInCondition(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite UNION subquery in IN condition generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
    ...
    public function testBuildWithQuery(): void
    {
        ...
        self::assertSame(
            str_replace("\n", ' ', $expectedQuerySql),
            $actualQuerySql,
            'SQLite WITH query with UNION generated unexpected SQL.',
        );
        self::assertEmpty(
            $queryParams,
