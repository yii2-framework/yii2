...
class ActiveForm extends Widget
{
     ...
     * This is because the default value of [[action]] is set to be the current request URL and each submit will add new
     * parameters instead of replacing existing ones.
    ...
    /**
     * @var int Number of milliseconds that the validation should be delayed when the user types in the field and
     * [[validateOnType]] is set `true`.
    ...
    /**
     * @var array The client validation options for individual attributes. Each element of the array represents the
