...
class CheckboxColumn extends Column
{
     ...
     *
     * The hidden input is a single global element (rendered once), so it cannot inherit per-row attributes from a
     * {@see $checkboxOptions} `Closure`. When {@see $checkboxOptions} is an array, `form` and `disabled` are inherited
     * automatically. When it is a `Closure`, set this property explicitly to control the hidden input attributes.
     */
     ...
     * - otherwise, `form` and `disabled` are inherited from {@see $checkboxOptions} when it is a static array.
     * - when {@see $checkboxOptions} is a `Closure`, no automatic inheritance occurs because the hidden input is a
     *   single global element without row context. Use {@see $unselectOptions} to set attributes explicitly.
     */
