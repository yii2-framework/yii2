...
/**
 * Data provider for {@see \yiiunit\framework\db\pgsql\conditions\InConditionBuilderTest} test cases.
 *
 * Provides PostgreSQL-specific input/output pairs for the IN/NOT IN condition builder.
 *
