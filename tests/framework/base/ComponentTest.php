...
final class ComponentTest extends TestCase
{
    ...
    public function testTriggerWildcard(): void
    {
        ...
        $this->component->on(
            'cli*', static function ($event) use (&$eventRaised): void {
                $eventRaised = true;
            },
        );
    ...
    public function testAttachBehaviors(): void
    {
        ...
        self::assertSame(['a' => $behavior, 'b' => $behavior], $component->getBehaviors(), 'Both behaviors should be attached.');
    }
    ...
    public function testDetachBehaviors(): void
    {
        ...
        self::assertNull(
            $component->getBehavior('a'),
            "Should be 'null' after 'detachBehaviors()'.",
        );
        self::assertNull(
            $component->getBehavior('b'),
            "Should be 'null' after 'detachBehaviors()'.",
    ...
    public function testOnPrependWildcardHandler(): void
    {
        ...
        $this->component->on('click.*', static function () use (&$order): void {
            $order[] = 'first';
        });
        $this->component->on('click.*', static function () use (&$order): void {
            $order[] = 'prepended';
