...
/**
 * Data provider for {@see \yiiunit\framework\db\oci\conditions\LikeConditionBuilderTest} test cases.
 *
 * Provides Oracle-specific input/output pairs for the LIKE condition builder.
 *
