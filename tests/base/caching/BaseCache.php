...
namespace yiiunit\base\caching;
 ...
 */
abstract class BaseCache extends TestCase
{
    /**
...
function time()
{
    return \yiiunit\base\caching\BaseCache::$time ?: \time();
}
...
{
    return \yiiunit\base\caching\BaseCache::$microtime ?: \microtime($float);
}